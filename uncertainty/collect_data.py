...
def main():
    ...
    parser.add_argument('--env_config', type=str, default='../control/configs/env-train.config')
    parser.add_argument('--policy_config', type=str, default='../control/configs/sarl/policy.config')
